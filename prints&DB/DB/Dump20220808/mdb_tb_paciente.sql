...
CREATE TABLE `tb_paciente` (
  ...
  `emailPaciente` varchar(256) DEFAULT NULL,
  `dataNascimentoPaciente` date NOT NULL,
  `telefonePaciente` varchar(14) DEFAULT NULL,
...
INSERT INTO `tb_paciente` VALUES ('57241790081','Pedro','pedro@pedrinho.com','1997-08-04','61983035663'),('94605017020','Marcelo','marcelo@marcelinho.com','1998-07-05','61987596236');
